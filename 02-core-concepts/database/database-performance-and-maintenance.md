...
-   
    ...
    [Indexing of large tables](#indexing-of-large-tables)

-   [Creating efficient queries](#creating-efficient-queries)

-   [Efficient database design](#efficient-database-design)
...
[📖] [**Learn more about indexing**](database-performance-and-maintenance/indexing.html)
...
[📖] [**Learn more about addons**](../the-function-stack/functions/database-requests/query-all-records.html#using-addons)
...
[📖] [**Read our documentation on database design**](designing-your-database.html)
