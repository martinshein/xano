...
-   
    ...
    [Add an Update Variable function to your function stack.](#add-an-update-variable-function-to-your-function-stack)

-   [Select the variable you want to update.](#select-the-variable-you-want-to-update)

-   [You can update the variable as a whole, or use dot notation to target a specific piece of data inside of it.](#you-can-update-the-variable-as-a-whole-or-use-dot-notation-to-target-a-specific-piece-of-data-inside)
