...
This means that if you have an API named /user/, you can not also have an API named /user/getUser
Description
...
[📖] **Learn more about API auto-documentation**
Request History
    ...
    -   ::: 
        ...
        **Allow Origins** - This section lets you specify which domains can access your API. The \"Add Origin\" button lets you:
        -   ::: 
            ...
            :::
            ::: 
            Add specific domains (e.g., https://yourfrontend.com)
            :::
        -   ::: 
            ::: 
            :::
...
Creating a new API
###  
Click [] to create a new API endpoint.
