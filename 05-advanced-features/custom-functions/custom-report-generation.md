...
-   
    ...
    [Report Generation using Database Views](#report-generation-using-database-views)

-   [Report Generation in the Function Stack](#report-generation-in-the-function-stack)

-   [Using APIs](#using-apis)

-   [Using Background Tasks](#using-background-tasks)

-   [Key Functions and Concepts](#key-functions-and-concepts)
...
[](../the-function-stack/functions/database-requests/query-all-records.html)

**Query All Records**

For retrieving data from your database

[](../the-function-stack/functions/data-manipulation/loops.html#for-each-loop)

**For Each Loops**

For iterating through retrieved records and transforming the data

[](../the-function-stack/filters.html)
